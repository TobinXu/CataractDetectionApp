...
CatarctEye = 'E:\\Graduation_thesis\\数据集\\cataractdataset\\dataset\\2_cataract'
filename = 'aa.txt'
# filepath = info + filename
# print(filepath)
path1 = "E:\\Graduation_thesis\\数据集\\cataractdataset\\dataset\\2_cataract"   #path to get original images
...
for itr in listing:
    ...
    imag=np.expand_dims(ndimage.imread("E:\\Graduation_thesis\\数据集\\cataractdataset\\dataset\\2_cataract/"+itr),0)
