...
training_set = train_datagen.flow_from_directory('E:\Graduation_thesis\Cataract\Train',
                                                   target_size=(64, 64),
                                                    batch_size=10,
                                                    #batch_size=855,
                                                    class_mode='binary')

test_set = test_datagen.flow_from_directory('E:\Graduation_thesis\Cataract\Test',
                                                target_size=(64, 64),
                                                 batch_size=10,
                                                 #batch_size=20,
                                                 class_mode='binary')
...
test_image = image.load_img('E:\\Graduation_thesis\\Cataract\\Test\\Cataract\\cataract_016g', target_size = (64, 64))
